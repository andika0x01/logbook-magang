  ...
  if (!user) {
    return (
      <main className="flex items-center justify-center min-h-[85vh] p-4 md:p-10 font-mono text-zinc-400 uppercase">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="console-panel max-w-xl w-full border-2 border-mission-border">
          ...
          <div className="p-8 md:p-16 text-center">
            ...
            <p className="text-zinc-400 text-sm md:text-base mb-8 md:mb-12 leading-relaxed uppercase tracking-wider font-bold">
              Secure terminal link requires pilot identification.
            </p>
            <a
              href="/login/google"
        ...
        {spaces.map((space: any, index: number) => (
          ...
          >
            ...
            <div className="p-8 flex items-center gap-6">
              <img
                src={space.avatar}
                className="w-16 h-16 grayscale group-hover:grayscale-0 border-2 border-mission-border group-hover:border-white transition-all shadow-xl"
                alt=""
              />
